...
public class DbCategory extends InstanceManager implements IController {
	private String select = "select * from bayer_category ";
	private String insert = "insert into bayer_category ";
	private String update = "update into bayer_category set";	
	public CategoryModel row;
	
	public DbCategory(ConnectionManager connectionManager) {
		this.row = new CategoryModel();			
